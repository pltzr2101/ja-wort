...
export const dict = {
  de: {
    ...
    rsvp: {
      ...
      attendingPlaceholder: "Bitte wählen",
      attendingYes: "Ich/Wir kommen gerne",
      attendingNo: "Ich/Wir müssen leider absagen",
      guests: "Personenzahl",
      additionalNames: "Vor- und Nachnamen der weiteren Personen",
      additionalNamesPlaceholder: "z. B. Anna Musterfrau, Ben Beispiel",
  ...
  ko: {
    ...
    hero: { cta: "참석 여부를 알려주세요" },
    countdown: { days: "일", hours: "시간", minutes: "분", seconds: "초" },
    gallery: { title: "갤러리" },
    map: { iframeTitle: "행사장 지도" },
    contact: { phone: "전화", whatsapp: "카카오톡", email: "계좌번호" },
    rsvp: {
      name: "성함",
      namePlaceholder: "성함",
      attending: "참석 여부를 알려주세요",
      attendingPlaceholder: "선택해 주세요",
      attendingYes: "참석합니다",
      attendingNo: "아쉽지만 참석하지 못합니다",
      guests: "인원 수",
      additionalNames: "동반 인원의 성함",
      additionalNamesPlaceholder: "예: 김철수, 이영희",
